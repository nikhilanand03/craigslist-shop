...
"""
FastAPI application for the Burgershack Environment.

This module creates an HTTP server that exposes the BurgershackEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m burgershack.server.app
